...
<body class= "bg-success">
    <h1 class="text-warning text-center p-3">Online Voting System</h1>
    <div class="bg-secondary py-4">
        ...
        <div class="container text-center">
            <form action="./actions/login.php" method="POST">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control w-50 m-auto" name="mobile" placeholder="Enter your mobile number" required="required" maxLength="11" minLength="11">
                </div>
                <div class="mb-3">
